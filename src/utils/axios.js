...
//     // CORS headers should NOT be manually added here.
//     // The browser handles CORS preflight automatically,
//     // and the NestJS backend should provide the appropriate
//     // Access-Control-Allow-Origin / Credentials response headers.

//     // Log the request details for debugging if needed:
//     // console.log('Making request:', {
//     //   url: config.url,
//     //   method: config.method,
//     //   baseURL: config.baseURL,
...
// // Mark initial load as complete after a delay to allow AuthContext
// // to handle initial auth checks.
// // This prevents premature redirects during page refresh.
// if (typeof window !== 'undefined') {
//   // Check if we're already on login page
//   const isLoginPage = window.location.pathname === '/';
...
//       // Always treat as session expired except during initial load
//       if (status === 401) {
//         // Only redirect if:
//         // 1. Initial load is complete
//         // 2. AuthContext is not handling it
//         // 3. Not on login page
//         // 4. Not already redirecting
//         if (
//           initialLoadComplete &&
...
//         ) {
//           console.warn(
//             'Session expired (401 Unauthorized). Clearing auth data and redirecting to login.'
//           );
...
//       // Only redirect after initial load and if not on login page
//       if (
//         status === 404 ||
//         errorCode === 'NOT_FOUND'
//       ) {
//         // During initial load or if AuthContext is handling it,
//         // let AuthContext manage the redirect.
...
//         ) {
//           console.warn(
//             'Session expired (404 NOT_FOUND). Clearing auth data and redirecting to login.'
//           );
...
//         // Always reject, but let AuthContext handle
...
// Program application overview API:
// import from './programApplicationOverviewApi.js'
// (not re-exported here to avoid circular dependency:
// that module imports this file).